...
import QueueMusicBox from './queueMusicBox.vue';
...
<div class="h-[90%] appear ">
            ...
            <div class="flex flex-col w-full gap-5 overflow-auto">
                ...
                <QueueMusicBox @action="getID" is_queue="true" v-else v-for="item in props.data_next" :data="item" />
            </div>
        </div>
</template>
